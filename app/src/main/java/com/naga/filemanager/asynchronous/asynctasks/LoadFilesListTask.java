...
import com.naga.filemanager.utils.OnFileFound;
...
public class LoadFilesListTask extends AsyncTask<Void, Void, Pair<OpenMode, ArrayList<LayoutElementParcelable>>> {
     ...
     *
     * @param path the path to the directory tree, starts with prefix {@link com.naga.filemanager.utils.OTGUtil#PREFIX_OTG}
